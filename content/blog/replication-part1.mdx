...
readTime: 3
image: "/diagrams/replication-part1/single-leader-replication.png"
category: "technical"
...
<img
  src="/diagrams/replication-part1/single-leader-replication.svg"
...
That is it for this one in next one will cover replication logs, replication lag, eventual consistency and multi leader replication.
